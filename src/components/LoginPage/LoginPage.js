...
function LoginPage() {
  ...
  const onSubmitNewUser = (newUser) => {
    ...
    if (!emailExist && !usernameExist) {
      ...
      reset();
      Swal.fire({
        title: 'Welcome to Desk Shop!',
        text: `Discount!!: DeskShop${newUser.username}`,
        icon: 'info'
      })
      login();
  };
      ...
      <div id="loginPage">
        ...
        <div className="loginPage__wrapper">
          <section className="login__title">
            <span>
              <h2>LOG IN INTO YOUR ACCOUNT or REGISTRER FOR DISCOUNTS!</h2>
            </span>
            <p>
                ...
                <Container component="main" maxWidth="xs">
                  ...
                  >
                    ...
                    <p className="login__signup__text">
                      Create your account for our amazing discounts across all
                      of our categories.
                    </p>
                    <Box
                      component="form"
